"""
Django settings for tennis_management_system project.
...
ROOT_URLCONF = 'tennis_management_system.urls'
...
WSGI_APPLICATION = 'tennis_management_system.wsgi.application'
